...
# Test script for user wallet endpoints
...
api_request "POST" "/users/create" '{"userId": "alice", "key": "alice-key"}'

# Create a wallet for Bob
print_header "Creating Wallet for Bob"
api_request "POST" "/users/create" '{"userId": "bob", "key": "bob-key"}'

# Create a DID for Alice
print_header "Creating DID for Alice"
api_request "POST" "/users/alice/did/create" '{"key": "alice-key", "method": "key", "keyType": "ed25519"}'

# Create a DID for Bob
print_header "Creating DID for Bob"
api_request "POST" "/users/bob/did/create" '{"key": "bob-key", "method": "key", "keyType": "ed25519"}'

# List DIDs for Alice
print_header "Listing DIDs for Alice"
api_request "GET" "/users/alice/did/list?key=alice-key"

# List DIDs for Bob
print_header "Listing DIDs for Bob"
api_request "GET" "/users/bob/did/list?key=bob-key"
